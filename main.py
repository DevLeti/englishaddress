...
class MyApp(QWidget):
    ...
    def initUI(self):
        ...
        self.tb.setAcceptRichText(True) # default : true
        self.tb.setOpenExternalLinks(True) # default : false?
        grid = QGridLayout()
        self.setLayout(grid)
        ...
        grid.addWidget(QPushButton('&Search'), 3,0)

        self.setWindowTitle('QGridLayout')
        self.setWindowIcon(QIcon('src/img/favicons.png'))

        self.setGeometry(300,300,400,300) # x,y,row size, column size
        self.show()
